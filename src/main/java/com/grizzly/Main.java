...
public class Main {
    ...
    private static void printUsage() {
        ...
        System.out.println("═══════════════════════════════════════");
        System.out.println();
        System.out.println("Required folder structure:");
        System.out.println();
        ...
        System.out.println("  my-project/");
        System.out.println("  └── output.json       (generated here)");
        System.out.println();
        ...
        System.out.println("═══════════════════════════════════════");
        System.out.println();
        System.out.println("Example examples/input.json:");
        System.out.println("{");
        ...
        System.out.println("}");
        System.out.println();
        System.out.println("Example examples/transform.py:");
